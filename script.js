...
var ToDoList = function (_React$Component) {
  ...
  _createClass(ToDoList, [{
    ...
    value: function handleSubmit(event) {
      ...
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=356", {
        method: "POST",
        mode: "cors",
    ...
    value: function deleteTask(id) {
      ...
      fetch('https://altcademy-to-do-list-api.herokuapp.com/tasks/' + id + '?api_key=356', {
        method: "DELETE",
        mode: "cors"
      }).then(checkStatus).then(json).then(function (data) {
    ...
    value: function toggleComplete(id, completed) {
      ...
      fetch('https://altcademy-to-do-list-api.herokuapp.com/tasks/' + id + '/mark_' + newState + '?api_key=356', {
        method: "PUT",
        mode: "cors"
      }).then(checkStatus).then(json).then(function (data) {
        _this4.fetchTasks();
    ...
    value: function fetchTasks() {
      ...
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=356").then(checkStatus).then(json).then(function (response) {
